...
public class Replace_Higher implements Command {
    ...
    /**
     * Выполняет команду замены значения по ключу, если новое значение больше старого.
     *
    ...
    public void execute(String arg) {
        ...
        // Замена значения, если новое значение больше старого
        if (newProduct.getPrice() > oldValue.getPrice()) {
            ...
            System.out.println("Значение для ключа '" + key + "' не заменено, так как новое значение не больше старого.");
        }
    }
}